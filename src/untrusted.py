...
# 移植自 anthropics/defending-code-reference-harness harness/prompts/untrusted.py（37 行，原样）。
...
opening and closing tag. The embedded text (target stderr, response bodies,
text another agent derived from it) is authored before the nonce exists, so it
